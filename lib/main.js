    ...
    (0, _createClass3.default)(BotApp, [{
        ...
        value: function _createOrderIframe(src) {
            if (this.orderIframeDOM) {
                ...
                // iframe.scrolling ='no';
                iframe.allowtransparency = 'yes';
                iframe.style.cssText = 'width: 100%;' + 'background-color: #fff;' + 'height: 100vh;' + 'position: fixed;' + 'left: 0;' + 'bottom: 0;' + 'z-index: ' + this.config.zIndex + ';' + 'border: none;' + 'margin: 0;' + 'padding: none;';
                document.body.appendChild(iframe);
            }
        }
    }, {
