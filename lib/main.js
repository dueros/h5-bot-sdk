    ...
    (0, _createClass3.default)(BotApp, [{
            ...
            this._getJSBridge(function (bridge) {
                bridge.registerHandler('onHandleIntent', function (payload, callback) {
                    ...
                    if (payload.intent.name === 'RenderAdvertisement') {
                        ...
                        if (!_this6.config.adDisable && !_this6._isCommonAdSwitchOff) {
                            if (payload.customData) {
                                _this6._renderAd(JSON.parse(payload.customData).jsonData);
                            }
                        }
                    } else {
                        cb(payload);
            ...
            this._getJSBridge(function (bridge) {
                bridge.registerHandler('onClickLink', function (payload, callback) {
                    ...
                    if (payload.url === 'http://sdk.bot.dueros.ai?action=unknown_utterance') {
                        _this7._handleUnknowUtteranceCb && _this7._handleUnknowUtteranceCb(null, JSON.parse(payload.params));
                    } else {
                        cb(payload);
                    }
                    // 告知app是否处理成功
            ...
            if (_data.status === 0) {
                ...
                if (this._adIframe1Loaded) {
                    ...
                    this._adIframe1.onload = function () {
                        _this8._adIframe1.contentWindow.postMessage(postData, _this8._adMsgTarget);
                        _this8._adIframe1Loaded = true;
                    };
                }
            } else {
        ...
        value: function _requestCommonadMaterial() {
            ...
            if (this.config.screenOrientation === 'portrait') {
                url = "dueros://f34646bc-37b4-a9db-361f-48fe7ca8831d/getAdResources?adPlaceId=5bnTSA3%2Bk%2FlCppVdt9bzxe%2B7gnZMFYgnMQLXt3dB%2FWFKf4lyam1he4m8ubUrZ0dj2d5T49v1ld1b9JHT%2B6ZhWIp9T6niQuPFPWCZ%2BpOIZhg%3D&botId=" + this.config.skillID;
            } else if (this.config.screenOrientation === 'landscape') {
                url = "dueros://f34646bc-37b4-a9db-361f-48fe7ca8831d/getAdResources?adPlaceId=5bnTSA3%2Bk%2FlCppVdt9bzxe%2B7gnZMFYgnMQLXt3dB%2FWFKf4lyam1he4m8ubUrZ0djtD6FVFxlJOQpWze3Tt6Lkop9T6niQuPFPWCZ%2BpOIZhg%3D&botId=" + this.config.skillID;
            }
            this.uploadLinkClicked({
                url: url,
                initiator: {
        ...
        value: function _startCommonAdSwitch(fireImmediately) {
            ...
            this._commonAdSwitchTimer = setInterval(function () {
                // 请求到素材后，会在onHandleIntent里处理
                _this9._requestCommonadMaterial();
