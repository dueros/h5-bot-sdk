...
export default {
    ...
    methods: {
        register(cb) {
            this.axios.get('/appvoicecontrol/botverification', {
                params: {
        ...
        getBotInfo() {
            this.axios.get('/appvoicecontrol/getsamplebotinfo', {
                params: {
                    botId: pageQuery.botId
                }
            })
        ...
        requireOAuth() {
            ...
            if (this.postMessageTargetOrigin) {
                ...
                console.error('H5 URL is illegal: ', this.postMessageTargetOrigin);
            }
        },
        denyOAuth() {
            if (this.postMessageTargetOrigin) {
        ...
        shipping(data) {
            this.axios.get('/appvoicecontrol/shippingorder', {
                params: {
                    botId: pageQuery.botId
                }
            }).then(({data}) => {
